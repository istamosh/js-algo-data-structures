...
const timeAgo = time => {
    ...
    // check if minute mark is less than an hour
    if (minutesAgo < 60) {
...
// exe tasks independently from the main program flow
const fetchData = async () => {
    // handle potential errors
    try {
        // awaits will waits for a promise to resolve and returns the result
...
const showLatestPosts = data => {
    ...
    // destructure the array inside the topic_list object

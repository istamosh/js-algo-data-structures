...
class Platform {
    constructor(x, y) {
        // using shorthand object x, y for the this.position
        this.position = {
            x, 
            y
        };
...
const animate = () => {
    ...
    // call draw method on every platform elements inside the platforms array
    ...
    platforms.forEach(platform => {
        ...
        // check if every element of collision rules array is true
